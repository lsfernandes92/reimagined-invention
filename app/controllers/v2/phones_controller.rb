  ...
  class PhonesController < ApplicationController
    ...
    def update
      if @phone.update!(phone_params)
        render json: @contact.phones, status: :ok, location: v2_contact_phones_url(@contact)
      else
    ...
    def create
      ...
      if @contact.save
        render json: @contact.phones, status: :created, location: v2_contact_phones_url(@contact)
      else
        render json: @contact.errors, status: :unprocessable_entity
      end
    end
