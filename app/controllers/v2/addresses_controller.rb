  ...
  class AddressesController < ApplicationController
    ...
    def update
      if @contact.address.update(address_params)
        render json: @contact.address, status: :ok, location: v2_contact_address_url(@contact)
      else
    ...
    def create
      ...
      if @contact.save
        render json: @contact.address, status: :created, location: v2_contact_address_url(@contact)
      else
        render json: @contact.errors, status: :unprocessable_entity
      end
    end
